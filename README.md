...
<b> svuplib </b> is a Go library for uploading files or byte data to IPFS through Pinata and returning the CID, gateway URL, filename, size, timestamp, and error metadata. Cross-platform support.
